...
class FoundryRestApi {
    ...
    init() {
        ...
        this.apiToken = game.settings.get('dmhub-rest-api', 'apiToken') || this.generateToken();
    ...
    registerSettings() {
        ...
        game.settings.register('dmhub-rest-api', 'allowedOrigins', {
     ...
     */
    startRestServer() {
        if (!game.settings.get('dmhub-rest-api', 'enableRestApi')) {
